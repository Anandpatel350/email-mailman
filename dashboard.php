        ...
        $(document).ready(function() {
            ...
            $(document).on("click", ".inboxclass", function(e) {
                ...
                jQuery.ajax({
                    ...
                    dataType: "JSON",
                    data: {
                        'selectrow_inbox': true,
                        'selectrow_inbox_data': trval
                    ...
                    success: function(data) {
                        ...
                        $.each(data, function(index, value) {
                            ...
                            tab += "<li><a class='dropdown-item link-primary' href='#'>From:- " + value.from_email + "</a></li>"
            ...
            $(document).on("click", "#Unread", function(e) {
                ...
                $.ajax({
                    ...
                    data: {
                        ...
                        inbox_value_unread_data: iddata
                    },
                    success: function(data) {
                        if (data['response']) {
                            $("#del,#Read,#Unread").hide();
