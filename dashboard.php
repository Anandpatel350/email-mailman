                        ...
                        success: function(data) {
                            if (data.status == false) {
                                ...
                                $.each(data, function(index, value) {
                                    ...
                                    $("#table-data").append("<tr><td><input type='checkbox' class='check' data-id=" + value.id + "></td><td>" + value.from_email + "</td><td>" + value.subject + "</td><td>" + value.time + "</td></tr>");
                                });
                            }
                    ...
                    jQuery.ajax({
                        ...
                        success: function(data) {
                            if (data.status == false) {
                                ...
                                $("#table-data").empty();
                                $.each(data, function(index, value) {
                                    $("#table-data").append("<tr><td><input type='checkbox' class='check' data-id=" + value.id + "></td><td>" + value.to_email + "</td><td>" + value.subject + "</td><td>" + value.time + "</td></tr>");
                                });
                            }
