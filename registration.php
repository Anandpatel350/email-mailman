              ...
              <div class="card-body  py-2 px-5">
                ...
                <form method="post" action="" enctype="maltipart/form-data" id="formdata">
                  ...
                  <div class="form-outline mb-3">
                    ...
                    <input type="text" id="FirstName" class="w-50 form-control form-control-lg" required />
                    <span id="nameErr" class="text-danger"></span>
                  </div>
                  <div class="form-outline mb-3">
                    <label class="form-label" for="LastName">Last Name</label>
                    <input type="text" id="LastName" class="w-50 form-control form-control-lg" required />
                    <span id="lnameErr" class="text-danger"></span>
                  </div>
                  <div class="form-outline mb-3">
                    <label class="form-label" for="UserName">User Name</label>
                    <input type="text" id="UserName" class="w-50 form-control form-control-lg" required />
                    <span id="unemeErr" class="text-danger"></span>
                  </div>

                  <div class="form-outline mb-3">
                    <label class="form-label" for="email">Enter Your Email</label>
                    <div class="d-flex"><input type="email" id="Email" class="w-50 form-control form-control-lg" required />
                  ...
                  <div class="form-outline mb-3">
                    ...
                    <input type="email" id="AltEmail" class="form-control form-control-lg" required />
                    <span id="cemailErr" class="text-danger"></span>
                  </div>
                  <div class="form-outline mb-3">
                    <label class="form-label" for="password">Enter New Password Here</label>
                    <div class="d-flex">
                      <input type="password" id="Password" class="form-control form-control-lg pe-5" required />
                  ...
                  <div class="form-check d-flex mb-5">
                    <label class="form-check-label" for="checkbox">
                      ...
                      I agree to the term and conditions of ManMail
                    </label>
                  </div>
                  ...
                  <div class="d-flex pb-5 pe-5">
                    ...
                    <button type="button" class="btn btn-success btn-block btn-lg gradient-custom-4 text-body">Sign-in Instead</button>
                  </div>
